...
public class AuthenticationService implements UserDetailsService, IAuthentication {
    ...
    public RegisterResponse register(RegisterRequest registerRequest) {
        ...
        List<OtpVerification> oldOtps = otpVerificationRepo.findByUserAndPurposeAndIsUseFalse(user,
                OtpPurpose.REGISTER);
        if (!oldOtps.isEmpty()) {
        ...
        // Return info the FE needs (e.g. email to pre-fill the form, OTP expiry time
        // for countdown)
    ...
    public ResendOtpResponse resendOtp(ResendOtpRequest request) {
        ...
        List<OtpVerification> oldOtps = otpVerificationRepo.findByUserAndPurposeAndIsUseFalse(user, purpose);
        if (!oldOtps.isEmpty()) {
            oldOtps.forEach(o -> o.setIsUse(true));
            otpVerificationRepo.saveAll(oldOtps);
        }
